...
--output_dir=gs://deep_speech_bucket/maggie/articles_results/articles_512_30K_5e-5/ \
--do_lower_case=True \
--do_train=True \
--do_eval=True \
--do_predict=False \
--use_tpu=True \
--tpu_name=$TPU_NAME \
--init_checkpoint=gs://deep_speech_bucket/maggie/bert_chkpts/articles_512_30K_5e-5/
